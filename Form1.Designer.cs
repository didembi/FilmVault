namespace nesneproje
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            button1.Location = new Point(335, 414);
            ...
            button2.Font = new Font("Segoe UI Black", 13.8F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point);
            button2.Location = new Point(575, 414);
            button2.Margin = new Padding(3, 2, 3, 2);
            button2.Name = "button2";
            button2.Size = new Size(213, 56);
            button2.TabIndex = 1;
            button2.Text = "Kullanıcı Girişi";
